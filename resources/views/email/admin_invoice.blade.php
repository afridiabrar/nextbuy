  ...
  <body>
    <main>
      ...
      <table style="width: 100%">
        <thead>
          <tr>
               <th class="service">Product Image</th>
        ...
        <tbody>
          ...
          <tr>
          <td><img style="width: 100px;height: 100px" src="{{ asset($img)}}"></td>
            <td class="service" style="text-align: center">{{ $item->product->name}}</td>
            <td class="desc" style="text-align: center">{{ number_format($item->price,2) }} aed</td>
