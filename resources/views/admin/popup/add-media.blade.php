...
<section class="popup view-popup">
  <div class="red-heading">
    <h4 class="p-2 text-uppercase">Add Media </h4>
  </div>
<form method="POST" enctype="multipart/form-data" action="{{ route('storeMedia')}}">
  @csrf
  <div class="col-md-12 text-left mt-4">
    ...
    <div class="col-md-12 text-center mt-5"> <a href="" class="">
      <button type="submit" class="view-button">Add Product Media</button>
    </div>
  </div>
</form>
</section>
