...
<section class="popup view-popup">
  <div class="red-heading">
    <h4 class="p-2 text-uppercase">Add Sub categories</h4>
  </div>
<form method="POST" enctype="multipart/form-data" action="{{ route('storeSubCategory')}}">
  @csrf
  <div class="col-md-12 text-left mt-4">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><input type="text" name="name" required placeholder="Sub Category Etc" /></td>
      </tr>
      <tr>
        <td>Banner Image</td>
        <td><input type="file" name="image"  placeholder="Computers Accessories" /></td>
      </tr>
      <tr>
        <td>Add Link</td>
        <td><input type="text" name="link"  placeholder="Computers Accessories" /></td>
      </tr>
      
    </table>
    <div class="col-md-12 text-center mt-5"> <a href="" class="">
      <button type="submit" class="view-button">Add Sub Category</button>
    </div>
  </div>
</form>
</section>
