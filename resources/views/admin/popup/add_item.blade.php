...
<section class="popup view-popup">
  <div class="red-heading">
    <h4 class="p-2 text-uppercase">Add Item</h4>
  </div>
<form action="{{ route('storeItem') }}" method="POST" enctype="multipart/form-data">
  <div class="col-md-12 text-left mt-4">
    ...
    <input type="hidden" name="order_id" value="{{$order->id}}">
      <tr>
        <td>Quantity</td>
        <td><input type="number"  name="qty" required placeholder="Enter Quantity" /></td>
      </tr>
      <tr>
        <td>Products</td>
        <td>
    ...
    <div class="col-md-12 text-center mt-5">
      <button class="view-button" type="submit">Add Item</button>
     </div>
  </div>
</form>
<br />
